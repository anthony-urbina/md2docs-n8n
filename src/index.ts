...
import { convertMarkdownToGoogleDoc } from "./services/google-docs";
import { convertMarkdownToDocx } from "./services/docx-converter";
...
export const mdToGoogleDoc = onRequest(
  {
    ...
    region: "us-east1", // Explicitly set region
